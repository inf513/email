...
public class Window extends javax.swing.JFrame {
    ...
    //public static String Username = "grupo06sa@ficct.uagrm.edu.bo";
    public static String Username = "grupo06sa";
    public static String PassWord = "grupo06grupo06";
    String Mensage = "";
    String To = "";
    String Subject = "";
    ...
    public void SendMail() {
        ...
        props.put("mail.smtp.user", "grupo06sa");
    ...
    private void initComponents() {
        ...
        jTextFieldTo.setText("limbertx@hotmail.com");

        jTextFieldSubject.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        jTextFieldSubject.setText("asunto");
        ...
        jTextAreaMessage.setText("mensahe");
